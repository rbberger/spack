...
class Lammps(CMakePackage, CudaPackage, ROCmPackage, PythonExtension):
    ...
    depends_on("intel-oneapi-mkl", when="+kokkos+kspace fft_kokkos=mkl_gpu")
    requires("^kokkos+sycl", when="fft_kokkos=mkl_gpu")
    ...
    conflicts("fft_kokkos=mkl_gpu", when="@:20240829", msg="fft_kokkos=mkl_gpu requires newer LAMMPS version")
